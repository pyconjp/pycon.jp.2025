            ...
            <div className="bg-white rounded-3xl border border-[#0000001A] my-20 pt-20 p-8 lg:p-20 lg:max-w-[640px] max-w-[335px]">
              <div className="flex flex-col">
                ...
                <div className="flex justify-center items-center gap-4">
                  <div className="rounded-xl border border-[#0000001A] w-[400px] h-[175px] flex justify-center items-center">
                    <ImageWithFallback src={`/common/sponsor/${currentSponsor.logo_image}`}
                      alt={lang === 'ja' ? currentSponsor.name_ja : currentSponsor.name_en}
                      width={480}
                      height={210}
                      className="w-92 h-42 p-5 object-contain"
                      fallback={'/common/logo_pc.png'}
                    />
                  </div>
                  <div className="rounded-xl border border-[#0000001A] p-8 w-[160px] h-[175px] flex justify-center items-center">
