...
export default function FixedMenu() {
  return (
    <div className="z-10 fixed bottom-0 w-full h-[310px] md:p-4">
      ...
      <div className="absolute max-md:mx-10 max-md:right-0 max-md:left-0 md:right-4 bottom-6 space-x-2 p-2 px-4 backdrop-blur-md bg-white rounded-full flex justify-center items-center md:space-x-6">
        <XButton/>
