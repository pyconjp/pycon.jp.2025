...
<div className="bg-[#FAFAFA] border border-[#0000001A] rounded-2xl p-5 mt-15">
  <div className="lg:grid grid-cols-2 gap-x-4 gap-y-2">
    <a href="#harassment_prohibited" className="flex justify-between items-center border-b border-gray-300 py-3 pr-2 no-underline">
      <span className="font-bold">Inappropriate Behavior</span>
    ...
    <a href="#weapons_prohibited" className="flex justify-between items-center border-b border-gray-300 py-3 pr-2 no-underline">
      <span className="font-bold">Weapons Policy</span>
      <span><FontAwesomeIcon icon={faArrowDown}/></span>
    </a>
    <a href="#follow_staff_instructions" className="col-span-2 flex justify-between items-center border-b border-gray-300 py-3 pr-2 no-underline">
      <span className="font-bold">All participants should follow instructions from the meeting staff.</span>
      <span><FontAwesomeIcon icon={faArrowDown}/></span>
    </a>
    ...
    <a href="#pyconjp2025_contacts" className="flex justify-between items-center border-b border-gray-300 py-3 pr-2 no-underline">
      <span className="font-bold">Contacts for PyCon JP 2025</span>
      <span><FontAwesomeIcon icon={faArrowDown}/></span>
    </a>
  </div>
</div>

<h2 id="harassment_prohibited">Inappropriate Behavior</h2>
...
<h2 id="weapons_prohibited">Weapons Policy</h2>
...
<h2 id="follow_staff_instructions">All participants should follow instructions from the meeting staff.</h2>
...
<h2 id="intensive_period">Intensive Response Period</h2>

At PyCon JP 2025, we designate the following period as the "Intensive Response Period" and will have a system in place to respond promptly to inquiries related to the Code of Conduct.

* Dates: From Friday, September 26, 2025 to Sunday, September 28, 2025 (including the Sprint day within the conference period)
* Hours: Each day, From venue opening (start of registration) until 30 minutes after the scheduled end time on the timetable. This includes the official party.
* Location: The conference venue and its surroundings, and the official party venue
* Other: For matters on the Internet that are clearly related to PyCon JP
...
<h3 id="pyconjp2025_contacts">Contacts for PyCon JP 2025</h3>

For this event, we have appointed three contact persons. You can reach out to the contact addresses listed above or contact them directly.

* Board member: [Maaya Ishida](https://www.pycon.jp/committee/board.html#maaya-ishida) [maaya@pycon.jp](mailto:maaya@pycon.jp)
* Vice-chair: <Link href="/en/members/nyoho">Yukinori Kitadai</Link> [nyoho@pycon.jp](mailto:nyoho@pycon.jp)
* Board member and Chairs team member: [Manabu TERADA](https://www.pycon.jp/committee/board.html#manabu-terada) [terada@pycon.jp](mailto:terada@pycon.jp)


<h2 id="coc_change_history">Change history</h2>

* 2025-08-28: Added the Intensive Response Period [Manabu TERADA]
