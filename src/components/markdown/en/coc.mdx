...
<div className="bg-[#FAFAFA] border border-[#0000001A] rounded-2xl p-5 mt-6">
  <div className="lg:grid grid-cols-2 gap-x-4 gap-y-2">
    ...
    <a href="#pyconjp2024_contacts" className="flex justify-between items-center border-b border-gray-300 py-3 pr-2 no-underline">
      <span className="font-bold">Contacts for PyCon JP 2024</span>
      <span><FontAwesomeIcon icon={faArrowDown}/></span>
    </a>
...
<h2 id="harassment_prohibited" className="!mt-6">Inappropriate Behavior</h2>
...
<h3 id="pyconjp2024_contacts">Contacts for PyCon JP 2024</h3>
...
<h2 id="modification_history">Change log</h2>
