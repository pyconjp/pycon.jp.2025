...
<div className="bg-[#FAFAFA] border border-[#0000001A] rounded-2xl p-5 mt-6">
  <div className="lg:grid grid-cols-2 gap-x-4 gap-y-2">
    ...
    <a href="#modification_history" className="flex justify-between items-center border-b border-gray-300 py-3 pr-2 no-underline">
      <span className="font-bold">改変記録</span>
      <span><FontAwesomeIcon icon={faArrowDown}/></span>
    </a>
    <div></div>
  </div>
...
<h2 id="harassment_prohibited" className="!mt-6 scroll-mt-20">ハラスメント行為の禁止</h2>
...
<h2 id="weapons_prohibited" className="scroll-mt-20">武器の携帯の禁止</h2>

* 武器には、爆発物(花火を含む)、銃、大型ナイフ、および他の人に怪我や危害を加える目的で使用されるその他の物品を含む
* これらの物品のいずれかを所持している人は、すぐに会場から立ち去るように求められ、武器なしでのみ戻ることができます。

<h2 id="follow_staff_instructions" className="scroll-mt-20">全ての参加者は会議スタッフからの指示に従ってください。</h2>
...
<h2 id="contact_information" className="scroll-mt-20">問い合わせ先</h2>

一般社団法人PyCon JP Associationが主催するイベントに関する、行動規範にの問い合わせ窓口

[coc@pycon.jp](mailto:coc@pycon.jp)

<h3 id="pyconjp2025_contacts" className="scroll-mt-20">PyCon JP 2025の担当者</h3>

本イベントにおいて、2名の担当者を設けております。上記のお問い合わせ先にご連絡いただくか、直接連絡いただくことができます。

* 共同座長兼理事: [寺田　学 (Manabu TERADA)](https://www.pycon.jp/committee/board.html#manabu-terada) [terada@pycon.jp](mailto:terada@pycon.jp)
* 理事: [石田 真彩 (Maaya Ishida)](https://www.pycon.jp/committee/board.html#maaya-ishida) [maaya@pycon.jp](mailto:maaya@pycon.jp)


<h2 id="modification_history" className="scroll-mt-20">改変記録</h2>

- 2024-08-06 問い合わせ先を追記 [Manabu TERADA]
- 2024-08-06 禁止行為の文言で「継続的な中断」で終わっていたものを「継続的な中断しようとする行為」に変更 [Manabu TERADA]
- 2024-09-15 PyCon JP 2024の担当者を追記 [Manabu TERADA]