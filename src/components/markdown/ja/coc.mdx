...
<div className="bg-[#FAFAFA] border border-[#0000001A] rounded-2xl p-5 mt-6">
  <div className="lg:grid grid-cols-2 gap-x-4 gap-y-2">
    ...
    <a href="#pyconjp2024_contacts" className="flex justify-between items-center border-b border-gray-300 py-3 pr-2 no-underline mt-1">
...
<h2 id="harassment_prohibited" className="!mt-6">ハラスメント行為の禁止</h2>
...
<h3 id="pyconjp2024_contacts">PyCon JP 2025の担当者</h3>
